				...
				<div class="m-stack__item m-brand m-stack__item--left">
					<div class="m-stack m-stack--ver m-stack--general m-stack--inline">
						<div class="m-stack__item m-stack__item--middle m-brand__logo">
							<a href="index.php?pc=&pn=حسابات" class="m-brand__logo-wrapper">
								<img alt="" src="assets/media/img/logo/logo.png" class="m-brand__logo-desktop"/>
								<img alt="" src="assets/media/img/logo/logo_mini.png" class="m-brand__logo-mobile"/>
							</a>
						</div>
								...
								<ul class="m-menu__nav  m-menu__nav--submenu-arrow ">
									<li class="m-menu__item  m-menu__item--active  m-menu__item--active-tab  m-menu__item--submenu m-menu__item--tabs"  m-menu-submenu-toggle="tab" aria-haspopup="true">
										<a  href="javascript:;" class="m-menu__link m-menu__toggle">
											<span class="m-menu__link-text">حسابات</span>
										...
										<div class="m-menu__submenu m-menu__submenu--classic m-menu__submenu--left m-menu__submenu--tabs">
											...
											<ul class="m-menu__subnav">
												<li class="m-menu__item "  m-menu-link-redirect="1" aria-haspopup="true">
													<a  href="index.php?pc=Ca&pn=حسابات زباين" class="m-menu__link ">
														<i class="m-menu__link-icon flaticon-support"></i>
														<span class="m-menu__link-text">حسابات زباين</span>
													</a>
												</li>
												<li class="m-menu__item "  aria-haspopup="true">
													<a  href="index.php?pc=Oa&pn=حسابات مكاتب" class="m-menu__link ">
														<i class="m-menu__link-icon flaticon-file"></i>
														<span class="m-menu__link-text">حسابات مكاتب</span>
													</a>
												</li>
												<li class="m-menu__item "  m-menu-link-redirect="1" aria-haspopup="true">
													<a  href="index.php?pc=Ea&pn=حسابات موظفين" class="m-menu__link ">
														<i class="m-menu__link-icon flaticon-coins"></i>
														<span class="m-menu__link-text">حسابات موظفين</span>
													</a>
												</li>
												...
												<li class="m-menu__item  m-menu__item--submenu m-menu__item--rel m-menu__item--submenu-tabs"  m-menu-submenu-toggle="click" m-menu-link-redirect="1" aria-haspopup="true">
													<a  href="javascript:;" class="m-menu__link m-menu__toggle">
														...
														<span class="m-menu__link-text">إختصارات</span>
														<i class="m-menu__hor-arrow la la-angle-down"></i>
														<i class="m-menu__ver-arrow la la-angle-right"></i>
													</a>
																	...
																	<ul class="m-menu__inner">
																		<li class="m-menu__item "  m-menu-link-redirect="1" aria-haspopup="true">
																			<a  href="inner2.html" class="m-menu__link ">
																				...
																				<span class="m-menu__link-text">موقع حجز التأمين الصحي</span>
																			</a>
																		</li>
																		<li class="m-menu__item "  m-menu-link-redirect="1" aria-haspopup="true">
																			<a  href="inner2.html" class="m-menu__link ">
																				<i class="m-menu__link-icon flaticon-map"></i>
																				<span class="m-menu__link-text">موقع الهجرة التركي</span>
																			</a>
																		</li>
																	</ul>
																</li>
													...
													<div class="m-menu__link m-menu__link--toggle-skip">
														<div class="dropdown">
															<a href="#" class="btn btn-primary m-btn m-btn--icon m-btn--pill m-btn--air   dropdown-toggle" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
																<i class="la la-plus"></i>&nbsp;&nbsp;إضافة حسابات

															</a>
															<div class="dropdown-menu dropdown-menu-right">
																<a class="dropdown-item" id="CustomerBtn"  data-toggle="modal" data-target="#CustomerModal" href="#">
																	<i class="flaticon-share"></i> حساب زبون
																</a>
																<a class="dropdown-item" id="OfficeBtn"  data-toggle="modal" data-target="#OfficeModal" href="#" href="#">
																	<i class="flaticon-settings"></i> حساب مكتب
																</a>
																<a class="dropdown-item" id="" id="EmpolyeBtn"  data-toggle="modal" data-target="#EmpolyeModal" href="#" href="#">
																	<i class="flaticon-graphic-2"></i> حساب موظف
																</a>
															</div>
														</div>
													</div>
									...
									<li class="m-menu__item  m-menu__item--submenu m-menu__item--tabs"   aria-haspopup="true">
										...
										<div class="m-menu__submenu m-menu__submenu--classic m-menu__submenu--left m-menu__submenu--tabs">
											...
											<!-- <ul class="m-menu__subnav">
												<li class="m-menu__item "  m-menu-link-redirect="1" aria-haspopup="true">
													<a  href="index.php?pc=&pn=" class="m-menu__link ">
									...
									<li class="m-menu__item  m-menu__item--submenu m-menu__item--tabs"  m-menu-submenu-toggle="tab" aria-haspopup="true">
										<a  href="javascript:;" class="m-menu__link m-menu__toggle">
											<span class="m-menu__link-text">شركات</span>
											<i class="m-menu__hor-arrow la la-angle-down"></i>
											<i class="m-menu__ver-arrow la la-angle-right"></i>
										</a>
										<div class="m-menu__submenu m-menu__submenu--classic m-menu__submenu--left m-menu__submenu--tabs">
											...
											<ul class="m-menu__subnav">
												...
												<li class="m-menu__item  m-menu__item--actions"  aria-haspopup="true">
													<div class="m-menu__link m-menu__link--toggle-skip">
														<div class="dropdown">
															<a href="#" class="btn btn-primary m-btn m-btn--icon m-btn--pill m-btn--air   dropdown-toggle" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
																<i class="la la-cloud-download"></i>&nbsp;&nbsp;إضافة

															</a>
															<div class="dropdown-menu dropdown-menu-right">
																<a class="dropdown-item" href="#">
																	<i class="flaticon-share"></i> Action
																</a>
																<a class="dropdown-item" href="#">
																	<i class="flaticon-settings"></i> Another action
																</a>
																<a class="dropdown-item" href="#">
																	<i class="flaticon-graphic-2"></i> Something else
																</a>
															</div>
														</div>
													</div>
									...
									<li class="m-menu__item  m-menu__item--submenu m-menu__item--tabs"  m-menu-submenu-toggle="tab" aria-haspopup="true">
										<a  href="javascript:;" class="m-menu__link m-menu__toggle">
											<span class="m-menu__link-text">جدول المهام اليومي</span>
											<i class="m-menu__hor-arrow la la-angle-down"></i>
											<i class="m-menu__ver-arrow la la-angle-right"></i>
										</a>
										<div class="m-menu__submenu m-menu__submenu--classic m-menu__submenu--left m-menu__submenu--tabs">
									...
									<li class="m-menu__item  m-menu__item--submenu m-menu__item--tabs"  m-menu-submenu-toggle="tab" aria-haspopup="true">
										...
										<div class="m-menu__submenu m-menu__submenu--classic m-menu__submenu--left m-menu__submenu--tabs">
											...
											<ul class="m-menu__subnav">
												<li class="m-menu__item "  m-menu-link-redirect="1" aria-haspopup="true">
													<a  href="index.php?pc=Services&pn=الخدمات" class="m-menu__link ">
														<i class="m-menu__link-icon flaticon-graphic-2"></i>
														<span class="m-menu__link-text">الخدمات</span>
													</a>
											 </li>
												<li class="m-menu__item "  m-menu-link-redirect="1" aria-haspopup="true">
													<a  href="index.php?pc=Users&pn=المستخدمين" class="m-menu__link ">
														<i class="m-menu__link-icon flaticon-analytics"></i>
